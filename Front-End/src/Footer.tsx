        ...
        <Grid container spacing={8}>
          ...
          <Grid item xs={12} sm={4}>
            ...
            <Typography variant="body2" sx={{ color: 'text.secondary', mt: 1 }}>
              We are offering unique and exciting tours to explore the city and its surroundings. Our mission is to
              provide personalized and memorable experiences for travelers. Join us on a journey to discover the best of

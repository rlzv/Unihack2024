                ...
                <Grid container spacing={8}>
                    ...
                    <Grid item xs={12} sm={4}>
                        ...
                        <Typography variant="body2" sx={{ color: 'text.secondary', mt: 1 }}>
                            We offer unique and exciting tours to explore the city and its surroundings. Our mission is to provide personalized and memorable experiences for travelers. Join us to discover the best of this vibrant destination.
                        </Typography>
                    </Grid>
    ...
    >
      {link.text}
                    ...
                    <Grid item xs={12} sm={3}>
                        ...
                        <Typography variant="body2" sx={{ color: 'text.secondary', mb: 1 }}>Str: Strada Alba Iulia nr.2 Timisoara</Typography>
                        <Typography variant="body2" sx={{ color: 'text.secondary', mb: 1 }}>Email: infocentru@e-uvt.ro</Typography>
                        <Typography variant="body2" sx={{ color: 'text.secondary', mb: 1 }}>Phone: +071234567</Typography>
                    </Grid>
                    ...
                    <Grid item xs={12} sm={3}>
                        ...
                        <form onSubmit={handleSubmit}>
                            <TextField
                                ...
                                fullWidth
                                required
                                sx={{ mb: 2, '& .MuiInputBase-root': { backgroundColor: 'white', borderRadius: 2, padding: '0 10px' } }}
                            />
                            <Button type="submit" variant="contained" color="primary" fullWidth sx={{ padding: '10px 0', borderRadius: 2 }}>
                                Subscribe
                            </Button>
                        </form>
                        {status.message && (
                            <Typography color={status.type === 'success' ? 'green' : 'red'} variant="body2" mt={1}>
                                {status.message}
                            </Typography>
                        )}
                    </Grid>
                ...
                <Box mt={5} display="flex" justifyContent="center" gap={4}>
                    {[Twitter, LinkedIn, Instagram, Facebook, YouTube].map((Icon, index) => (
                        <IconButton
                            key={index}
                            href="#"
                            color="inherit"
                            aria-label={Icon.displayName}
                            sx={{ color: 'white', backgroundColor: '#0070bb', '&:hover': { backgroundColor: '#005faf' } }}
                        >
                            <Icon />
                        </IconButton>
                    ))}
